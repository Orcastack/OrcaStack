  ...
  return (
    <>
      <section className="page-hero">
        ...
        <p>
          The community page gives ORCASTACK a stronger front-of-house presence for contributors, platform adopters, and operational stakeholders who need a shared understanding of how the system evolves.
        </p>
      </section>
